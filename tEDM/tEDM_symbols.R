...
png("./tEDM/M.png", width = 1600, height = 1600, res = 300, bg = "transparent")
...
png("./tEDM/Mx.png", width = 1600, height = 1600, res = 300, bg = "transparent")
plot3D::lines3D(lorenz[,1], lorenz[,2], lorenz[,3], colvar = NULL, col = cols,
...
png("./tEDM/My.png", width = 1600, height = 1600, res = 300, bg = "transparent")
plot3D::lines3D(lorenz[,1], lorenz[,2], lorenz[,3], colvar = NULL, col = cols,
